...
{
    public static void CalculateDiffAxisAngle(ref Matrix4x4 transform0, ref Matrix4x4 transform1, out Vector3 axis, out float angle)
    ...
    public static void CalculateVelocity(ref Matrix4x4 transform0, ref Matrix4x4 transform1, float timeStep, out Vector3 linVel, out Vector3 angVel)
    ...
    public static void IntegrateTransform(ref Matrix4x4 curTrans, ref Vector3 linvel, ref Vector3 angvel, float timeStep, out Matrix4x4 predictedTransform)
...
public class ConvexSeparatingDistanceUtil : BulletDisposableObject
{
    ...
    public void InitSeparatingDistance(ref Vector3 separatingVector, float separatingDistance, ref Matrix4x4 transA, ref Matrix4x4 transB)
        => btConvexSeparatingDistanceUtil_initSeparatingDistance(Native, ref separatingVector, separatingDistance, ref transA, ref transB);

    public void UpdateSeparatingDistance(ref Matrix4x4 transA, ref Matrix4x4 transB)
        => btConvexSeparatingDistanceUtil_updateSeparatingDistance(Native, ref transA, ref transB);
