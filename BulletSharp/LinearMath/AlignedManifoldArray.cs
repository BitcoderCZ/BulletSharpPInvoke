...
public class AlignedManifoldArray : BulletDisposableObject, IList<PersistentManifold>
{
    ...
    public int IndexOf(PersistentManifold item) => throw new NotImplementedException();

    public void Insert(int index, PersistentManifold item) => throw new NotImplementedException();
    ...
    public bool Remove(PersistentManifold item) => throw new NotImplementedException();

    public IEnumerator<PersistentManifold> GetEnumerator() => new AlignedManifoldArrayEnumerator(this);

    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => new AlignedManifoldArrayEnumerator(this);

    protected override void Dispose(bool disposing) => btAlignedObjectArray_btPersistentManifoldPtr_delete(Native);
}
