...
public class AlignedFaceArray : BulletObject, IList<Face>
{
    ...
    public int IndexOf(Face item) => throw new NotImplementedException();

    public void Insert(int index, Face item) => throw new NotImplementedException();
    ...
    public void Add(Face item) => btAlignedObjectArray_btSoftBody_Face_push_back(Native, item.Native);

    public void Clear() => btAlignedObjectArray_btSoftBody_Face_resizeNoInitialize(Native, 0);

    public bool Contains(Face item) => throw new NotImplementedException();

    public void CopyTo(Face[] array, int arrayIndex) => throw new NotImplementedException();

    public int Count => btAlignedObjectArray_btSoftBody_Face_size(Native);

    public bool IsReadOnly => false;

    public bool Remove(Face item) => throw new NotImplementedException();

    public IEnumerator<Face> GetEnumerator() => new AlignedFaceArrayEnumerator(this);

    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => new AlignedFaceArrayEnumerator(this);
}
