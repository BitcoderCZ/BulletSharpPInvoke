...
public class SoftBodyConcaveCollisionAlgorithm : CollisionAlgorithm
{
    public class CreateFunc : CollisionAlgorithmCreateFunc
    {
        ...
        public override CollisionAlgorithm CreateCollisionAlgorithm(CollisionAlgorithmConstructionInfo __unnamed0,
            CollisionObjectWrapper body0Wrap, CollisionObjectWrapper body1Wrap) => new SoftBodyConcaveCollisionAlgorithm(btCollisionAlgorithmCreateFunc_CreateCollisionAlgorithm(
    ...
    public void ClearCache() => btSoftBodyConcaveCollisionAlgorithm_clearCache(Native);
}
