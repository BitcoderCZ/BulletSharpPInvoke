...
public class SoftBodySolver : BulletDisposableObject
{
    ...
    public bool CheckInitialized() => btSoftBodySolver_checkInitialized(Native);

    public void CopyBackToSoftBodies(bool bMove = true) => btSoftBodySolver_copyBackToSoftBodies(Native, bMove);
    /*
		...
		*/
    public void PredictMotion(float solverdt) => btSoftBodySolver_predictMotion(Native, solverdt);
    /*
		...
		*/
    public void SolveConstraints(float solverdt) => btSoftBodySolver_solveConstraints(Native, solverdt);

    public void UpdateSoftBodies() => btSoftBodySolver_updateSoftBodies(Native);
    ...
    protected override void Dispose(bool disposing) => btSoftBodySolver_delete(Native);
}
/*
