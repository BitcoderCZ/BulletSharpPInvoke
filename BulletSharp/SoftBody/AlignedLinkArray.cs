...
public class AlignedLinkArray : BulletObject, IList<Link>
{
    ...
    public int IndexOf(Link item) => throw new NotImplementedException();

    public void Insert(int index, Link item) => throw new NotImplementedException();
    ...
    public void Add(Link item) => btAlignedObjectArray_btSoftBody_Link_push_back(Native, item.Native);

    public void Clear() => btAlignedObjectArray_btSoftBody_Link_resizeNoInitialize(Native, 0);

    public bool Contains(Link item) => throw new NotImplementedException();
    ...
    public bool Remove(Link item) => throw new NotImplementedException();

    public IEnumerator<Link> GetEnumerator() => new AlignedLinkArrayEnumerator(this);

    System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => new AlignedLinkArrayEnumerator(this);
}
