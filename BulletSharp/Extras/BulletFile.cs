...
public class BulletFile : bFile
{
    ...
    public List<byte[]> CollisionObjects = [];
    public List<byte[]> CollisionShapes = [];
    public List<byte[]> Constraints = [];
    public List<byte[]> DynamicsWorldInfo = [];
    public List<byte[]> MultiBodies = [];
    public List<byte[]> RigidBodies = [];
