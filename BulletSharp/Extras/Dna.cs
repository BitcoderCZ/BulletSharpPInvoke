...
public class Dna
{
    ...
    public class StructDecl
    {
        ...
        public override int GetHashCode() => Type.GetHashCode() ^ Elements.Length;
    ...
    public StructDecl GetStruct(int i) => _structs[i];
    ...
    public bool IsBroken(int fileVersion) => fileVersion == 276 && _hasIntType;
