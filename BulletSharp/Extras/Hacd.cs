...
public class Hacd : BulletDisposableObject
{
    ...
    public bool Compute()
        => HACD_HACD_Compute(Native);

    public bool Compute(bool fullCH)
        => HACD_HACD_Compute2(Native, fullCH);

    public bool Compute(bool fullCH, bool exportDistPoints)
        => HACD_HACD_Compute3(Native, fullCH, exportDistPoints);
    ...
    public int GetNPointsCH(int numCH)
        => HACD_HACD_GetNPointsCH(Native, numCH);

    public int GetNTrianglesCH(int numCH)
        => HACD_HACD_GetNTrianglesCH(Native, numCH);
