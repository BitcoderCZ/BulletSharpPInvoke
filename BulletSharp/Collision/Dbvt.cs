...
public class DbvtAabbMm : BulletObject
{
    ...
    public int Classify(Vector3 n, float o, int s)
        => btDbvtAabbMm_Classify(Native, ref n, o, s);

    public bool Contain(DbvtAabbMm a)
        => btDbvtAabbMm_Contain(Native, a.Native);
    ...
    public float ProjectMinimum(Vector3 v, uint signs)
        => btDbvtAabbMm_ProjectMinimum(Native, ref v, signs);
...
public class DbvtNode : BulletObject
{
    ...
    public override bool Equals(object obj)
        => this == obj || (obj is DbvtNode other && Native == other.Native);
...
public class Dbvt : BulletObject
{
    ...
    public override bool Equals(object obj)
        => this == obj || (obj is Dbvt other && Native == other.Native);
    ...
    public DbvtNode Insert(DbvtVolume box, IntPtr data)
        => new DbvtNode(btDbvt_insert(Native, box.Native, data));
    ...
    public bool Update(DbvtNode leaf, DbvtVolume volume, float margin)
        => btDbvt_update4(Native, leaf.Native, volume.Native, margin);

    public bool Update(DbvtNode leaf, DbvtVolume volume, Vector3 velocity)
        => btDbvt_update5(Native, leaf.Native, volume.Native, ref velocity);

    public bool Update(DbvtNode leaf, DbvtVolume volume, Vector3 velocity, float margin)
        => btDbvt_update6(Native, leaf.Native, volume.Native, ref velocity, margin);
...
#pragma warning disable SA1313 // Parameter names should begin with lower-case letter
        public bool AllLeaves(DbvtNode __unnamed0)
            => btDbvt_ICollide_AllLeaves(Native, __unnamed0.Native);

        public bool Descent(DbvtNode __unnamed0)
            => btDbvt_ICollide_Descent(Native, __unnamed0.Native);
...
#pragma warning restore SA1313 // Parameter names should begin with lower-case letter
            => btDbvt_IWriter_WriteNode(Native, __unnamed0.Native, index, parent, child0, child1);

        protected override void Dispose(bool disposing) => btDbvt_IWriter_delete(Native);
    }
    ...
    public class StkNP : BulletDisposableObject
    {
        ...
        protected override void Dispose(bool disposing) => btDbvt_sStkNP_delete(Native);
    }
    ...
    public class StkNps : BulletDisposableObject
    {
        ...
        protected override void Dispose(bool disposing) => btDbvt_sStkNPS_delete(Native);
    }
}
