...
public class TriangleMeshShape : ConcaveShape
{
    ...
    public void LocalGetSupportingVertex(ref Vector3 vec, out Vector3 value) => btTriangleMeshShape_localGetSupportingVertex(Native, ref vec, out value);
    ...
    public void LocalGetSupportingVertexWithoutMargin(ref Vector3 vec, out Vector3 value) => btTriangleMeshShape_localGetSupportingVertexWithoutMargin(Native, ref vec,
            out value);
    ...
    public void RecalcLocalAabb() => btTriangleMeshShape_recalcLocalAabb(Native);
...
internal struct TriangleMeshShapeData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(TriangleMeshShapeData), fieldName).ToInt32();
}
