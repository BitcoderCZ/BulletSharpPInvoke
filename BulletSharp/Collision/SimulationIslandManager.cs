...
public class SimulationIslandManager : BulletObject
{
    ...
    public void BuildAndProcessIslands(Dispatcher dispatcher, CollisionWorld collisionWorld, IslandCallback callback)
        => btSimulationIslandManager_buildAndProcessIslands(Native, dispatcher.Native, collisionWorld.Native, callback.Native);
    ...
    public void UpdateActivationState(CollisionWorld colWorld, Dispatcher dispatcher)
        => btSimulationIslandManager_updateActivationState(Native, colWorld.Native, dispatcher.Native);
