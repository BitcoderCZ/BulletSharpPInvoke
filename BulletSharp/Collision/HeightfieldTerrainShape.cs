...
public class HeightfieldTerrainShape : ConcaveShape
{
    ...
    {
        IntPtr native = btHeightfieldTerrainShape_new(heightStickWidth, heightStickLength, heightfieldData, heightScale, minHeight, maxHeight, upAxis, heightDataType, flipQuadEdges);
