...
public class ConvexCast : BulletDisposableObject
{
    ...
    public bool CalcTimeOfImpact(Matrix4x4 fromA, Matrix4x4 toA, Matrix4x4 fromB, Matrix4x4 toB, CastResult result)
        => btConvexCast_calcTimeOfImpact(Native, ref fromA, ref toA, ref fromB, ref toB, result.Native);
