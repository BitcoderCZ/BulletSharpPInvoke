...
public class ConvexTriangleMeshShape : PolyhedralConvexAabbCachingShape
{
    ...
    public void CalculatePrincipalAxisTransform(Matrix4x4 principal, out Vector3 inertia, out float volume)
        => btConvexTriangleMeshShape_calculatePrincipalAxisTransform(Native, ref principal, out inertia, out volume);
}
