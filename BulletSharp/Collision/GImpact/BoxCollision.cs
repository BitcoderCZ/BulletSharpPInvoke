...
public class BoxBoxTransformCache : BulletDisposableObject
{
    ...
    public void CalculateFromFullInvert(Matrix4x4 transform0, Matrix4x4 transform1) => BT_BOX_BOX_TRANSFORM_CACHE_calc_from_full_invert(Native, ref transform0, ref transform1);
    ...
    protected override void Dispose(bool disposing) => BT_BOX_BOX_TRANSFORM_CACHE_delete(Native);
}
...
public sealed class Aabb : BulletDisposableObject
{
    ...
    public bool CollideTriangleExactRef(ref Vector3 p1, ref Vector3 p2, ref Vector3 p3, ref Vector4 trianglePlane)
        => btAABB_collide_triangle_exact(Native, ref p1, ref p2, ref p3, ref trianglePlane);
    ...
    public bool HasCollision(Aabb other)
        => btAABB_has_collision(Native, other.Native);
    ...
    public bool OverlappingTransCache(Aabb box, BoxBoxTransformCache transformCache, bool fullTest)
        => btAABB_overlapping_trans_cache(Native, box.Native, transformCache.Native, fullTest);

    public bool OverlappingTransConservativeRef(Aabb box, ref Matrix4x4 transform1To0)
        => btAABB_overlapping_trans_conservative(Native, box.Native, ref transform1To0);
    ...
    public bool OverlappingTransConservative2(Aabb box, BoxBoxTransformCache transform1To0)
        => btAABB_overlapping_trans_conservative2(Native, box.Native, transform1To0.Native);

    public PlaneIntersectionType PlaneClassify(Vector4 plane)
        => btAABB_plane_classify(Native, ref plane);
