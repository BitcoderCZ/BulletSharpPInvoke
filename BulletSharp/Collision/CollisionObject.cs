...
internal struct CollisionObjectFloatData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(CollisionObjectFloatData), fieldName).ToInt32();
}
...
internal struct CollisionObjectDoubleData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(CollisionObjectDoubleData), fieldName).ToInt32();
}
...
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    public int CalculateSerializeBufferSize()
        => btCollisionObject_calculateSerializeBufferSize(Native);

    public bool CheckCollideWith(CollisionObject co)
        => btCollisionObject_checkCollideWith(Native, co.Native);

    public bool CheckCollideWithOverride(CollisionObject co)
        => btCollisionObject_checkCollideWithOverride(Native, co.Native);
    ...
    public bool GetCustomDebugColor(out Vector3 colorRgb)
        => btCollisionObject_getCustomDebugColor(Native, out colorRgb);
    ...
    public bool HasAnisotropicFriction(AnisotropicFrictionFlags frictionMode = AnisotropicFrictionFlags.Friction)
        => btCollisionObject_hasAnisotropicFriction(Native, frictionMode);

    public IntPtr InternalGetExtensionPointer()
        => btCollisionObject_internalGetExtensionPointer(Native);
    ...
    public bool MergesSimulationIslands()
        => btCollisionObject_mergesSimulationIslands(Native);
    ...
    public string Serialize(IntPtr dataBuffer, Serializer serializer)
        => Marshal.PtrToStringAnsi(btCollisionObject_serialize(Native, dataBuffer, serializer.Native));

    public void SerializeSingleObject(Serializer serializer)
        => btCollisionObject_serializeSingleObject(Native, serializer.Native);

    public void SetAnisotropicFrictionRef(ref Vector3 anisotropicFriction, AnisotropicFrictionFlags frictionMode = AnisotropicFrictionFlags.Friction)
        => btCollisionObject_setAnisotropicFriction(Native, ref anisotropicFriction, frictionMode);

    public void SetAnisotropicFriction(Vector3 anisotropicFriction, AnisotropicFrictionFlags frictionMode = AnisotropicFrictionFlags.Friction)
        => btCollisionObject_setAnisotropicFriction(Native, ref anisotropicFriction, frictionMode);
    ...
    public override bool Equals(object? obj)
        => obj is CollisionObject other && Native == other.Native;
