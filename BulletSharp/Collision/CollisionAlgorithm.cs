...
public class CollisionAlgorithmConstructionInfo : BulletDisposableObject
{
    ...
    {
        Native = btCollisionAlgorithmConstructionInfo_new2((dispatcher != null) ? dispatcher.Native : IntPtr.Zero, temp);
...
public class CollisionAlgorithm : BulletDisposableObject
{
    ...
    public float CalculateTimeOfImpact(CollisionObject body0, CollisionObject body1, DispatcherInfo dispatchInfo, ManifoldResult resultOut)
        => btCollisionAlgorithm_calculateTimeOfImpact(Native, body0.Native, body1.Native, dispatchInfo.Native, resultOut.Native);
    ...
    public void ProcessCollision(CollisionObjectWrapper body0Wrap, CollisionObjectWrapper body1Wrap, DispatcherInfo dispatchInfo, ManifoldResult resultOut)
        => btCollisionAlgorithm_processCollision(Native, body0Wrap.Native, body1Wrap.Native, dispatchInfo.Native, resultOut.Native);
