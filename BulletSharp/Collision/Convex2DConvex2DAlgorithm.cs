...
public class Convex2DConvex2DAlgorithm : ActivatingCollisionAlgorithm
{
    ...
    {
        IntPtr native = btConvex2dConvex2dAlgorithm_new(mf.Native, ci.Native, body0Wrap.Native, body1Wrap.Native, simplexSolver.Native, pdSolver.Native, numPerturbationIterations, minimumPointsPerturbationThreshold);
    ...
    public class CreateFunc : CollisionAlgorithmCreateFunc
    {
        ...
        {
            IntPtr native = btConvex2dConvex2dAlgorithm_CreateFunc_new(simplexSolver.Native, pdSolver.Native);
            InitializeUserOwned(native);
        ...
        public override CollisionAlgorithm CreateCollisionAlgorithm(CollisionAlgorithmConstructionInfo __unnamed0, CollisionObjectWrapper body0Wrap, CollisionObjectWrapper body1Wrap)
            => new Convex2DConvex2DAlgorithm(btCollisionAlgorithmCreateFunc_CreateCollisionAlgorithm(Native, __unnamed0.Native, body0Wrap.Native, body1Wrap.Native), __unnamed0.Dispatcher);
    }
}
