...
public class GhostObject : CollisionObject
{
    ...
    public void AddOverlappingObjectInternal(BroadphaseProxy otherProxy, BroadphaseProxy thisProxy = null) => btGhostObject_addOverlappingObjectInternal(Native, otherProxy.Native,
    ...
    public void ConvexSweepTestRef(ConvexShape castShape, ref Matrix4x4 convexFromWorld,
        ref Matrix4x4 convexToWorld, ConvexResultCallback resultCallback, float allowedCcdPenetration = 0) => btGhostObject_convexSweepTest(Native, castShape.Native, ref convexFromWorld,
    ...
    public void ConvexSweepTest(ConvexShape castShape, Matrix4x4 convexFromWorld,
        Matrix4x4 convexToWorld, ConvexResultCallback resultCallback, float allowedCcdPenetration = 0) => btGhostObject_convexSweepTest(Native, castShape.Native, ref convexFromWorld,
            ref convexToWorld, resultCallback.Native, allowedCcdPenetration);

    public CollisionObject GetOverlappingObject(int index) => GetManaged(btGhostObject_getOverlappingObject(
            Native, index));

    public void RayTestRef(ref Vector3 rayFromWorld, ref Vector3 rayToWorld, RayResultCallback resultCallback) => btGhostObject_rayTest(Native, ref rayFromWorld, ref rayToWorld, resultCallback.Native);
    ...
    public void RemoveOverlappingObjectInternal(BroadphaseProxy otherProxy, Dispatcher dispatcher,
        BroadphaseProxy thisProxy = null) => btGhostObject_removeOverlappingObjectInternal(Native, otherProxy.Native,
            dispatcher.Native, (thisProxy != null) ? thisProxy.Native : IntPtr.Zero);

    public static GhostObject Upcast(CollisionObject colObj) => GetManaged(btGhostObject_upcast(colObj.Native)) as GhostObject;
...
public sealed class GhostPairCallback : OverlappingPairCallback
{
    ...
    public override IntPtr RemoveOverlappingPair(BroadphaseProxy proxy0, BroadphaseProxy proxy1, Dispatcher dispatcher) => btOverlappingPairCallback_removeOverlappingPair(Native, proxy0.Native,
