...
public abstract class OverlapFilterCallback : BulletDisposableObject
{
    ...
    private bool NeedBroadphaseCollisionUnmanaged(IntPtr proxy0, IntPtr proxy1) => NeedBroadphaseCollision(BroadphaseProxy.GetManaged(proxy0), BroadphaseProxy.GetManaged(proxy1));

    public abstract bool NeedBroadphaseCollision(BroadphaseProxy proxy0, BroadphaseProxy proxy1);

    protected override void Dispose(bool disposing) => btOverlapFilterCallback_delete(Native);
}
...
public abstract class OverlappingPairCache : OverlappingPairCallback
{
    ...
    public void CleanOverlappingPair(BroadphasePair pair, Dispatcher dispatcher) => btOverlappingPairCache_cleanOverlappingPair(Native, pair.Native, dispatcher.Native);

    public void CleanProxyFromPairs(BroadphaseProxy proxy, Dispatcher dispatcher) => btOverlappingPairCache_cleanProxyFromPairs(Native, proxy.Native, dispatcher.Native);

    public BroadphasePair FindPair(BroadphaseProxy proxy0, BroadphaseProxy proxy1) => new BroadphasePair(btOverlappingPairCache_findPair(Native, proxy0.Native, proxy1.Native));

    public void ProcessAllOverlappingPairs(OverlapCallback __unnamed0, Dispatcher dispatcher) => btOverlappingPairCache_processAllOverlappingPairs(Native, __unnamed0.Native,
            dispatcher.Native);

    public void ProcessAllOverlappingPairs(OverlapCallback __unnamed0, Dispatcher dispatcher,
        DispatcherInfo dispatcherInfo) => btOverlappingPairCache_processAllOverlappingPairs2(Native, __unnamed0.Native,
    ...
    public void SetOverlapFilterCallback(OverlapFilterCallback callback) => btOverlappingPairCache_setOverlapFilterCallback(Native, callback.Native);

    public void SortOverlappingPairs(Dispatcher dispatcher) => btOverlappingPairCache_sortOverlappingPairs(Native, dispatcher.Native);
...
public class HashedOverlappingPairCache : OverlappingPairCache
{
    ...
    public override BroadphasePair AddOverlappingPair(BroadphaseProxy proxy0, BroadphaseProxy proxy1) => new BroadphasePair(btOverlappingPairCallback_addOverlappingPair(Native, proxy0.Native,
            proxy1.Native));

    public bool NeedsBroadphaseCollision(BroadphaseProxy proxy0, BroadphaseProxy proxy1) => btHashedOverlappingPairCache_needsBroadphaseCollision(Native,
            proxy0.Native, proxy1.Native);

    public override IntPtr RemoveOverlappingPair(BroadphaseProxy proxy0, BroadphaseProxy proxy1,
        Dispatcher dispatcher) => btOverlappingPairCallback_removeOverlappingPair(Native, proxy0.Native,
            proxy1.Native, dispatcher.Native);

    public override void RemoveOverlappingPairsContainingProxy(BroadphaseProxy proxy0,
        Dispatcher dispatcher) => btOverlappingPairCallback_removeOverlappingPairsContainingProxy(Native,
...
public class SortedOverlappingPairCache : OverlappingPairCache
{
    ...
    public bool NeedsBroadphaseCollision(BroadphaseProxy proxy0, BroadphaseProxy proxy1) => btSortedOverlappingPairCache_needsBroadphaseCollision(Native,
            proxy0.Native, proxy1.Native);
...
public class NullPairCache : OverlappingPairCache
{
    ...
    public override void RemoveOverlappingPairsContainingProxy(BroadphaseProxy proxy0,
        Dispatcher dispatcher) => btOverlappingPairCallback_removeOverlappingPairsContainingProxy(Native, proxy0.Native,
            dispatcher.Native);
}
