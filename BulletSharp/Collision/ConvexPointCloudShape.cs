...
public class ConvexPointCloudShape : PolyhedralConvexAabbCachingShape
{
    ...
    public ConvexPointCloudShape(Vector3Array points, int numPoints, Vector3 localScaling, bool computeAabb = true)
    {
        IntPtr native = btConvexPointCloudShape_new2(points.Native, numPoints, ref localScaling, computeAabb);
        InitializeCollisionShape(native);
    ...
    public Vector3Array? UnscaledPoints
    {
        ...
        set => SetPoints(value, value.Count);
    }
    ...
    {
        btConvexPointCloudShape_setPoints(Native, points.Native, numPoints, computeAabb);
        _unscaledPoints = points;
    }

    public void SetPoints(Vector3Array points, int numPoints, bool computeAabb, Vector3 localScaling)
    {
        btConvexPointCloudShape_setPoints2(Native, points.Native, numPoints, computeAabb, ref localScaling);
        _unscaledPoints = points;
    }
}
