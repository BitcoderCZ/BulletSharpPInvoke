...
public abstract class DynamicsWorld : CollisionWorld
{
    ...
    private List<TypedConstraint> _constraints = [];
    ...
    public void ClearForces() => btDynamicsWorld_clearForces(Native);
    ...
    public void GetGravity(out Vector3 gravity) => btDynamicsWorld_getGravity(Native, out gravity);
    ...
    public void SetGravity(ref Vector3 gravity) => btDynamicsWorld_setGravity(Native, ref gravity);

    private void InternalPreTickCallbackNative(IntPtr world, float timeStep) => _preTickCallback(this, timeStep);

    private void InternalPostTickCallbackNative(IntPtr world, float timeStep) => _postTickCallback(this, timeStep);
    ...
    public void SynchronizeMotionStates() => btDynamicsWorld_synchronizeMotionStates(Native);
