...
internal struct ConeTwistConstraintFloatData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(ConeTwistConstraintFloatData), fieldName).ToInt32();
}
...
internal struct ConeTwistConstraintDoubleData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(ConeTwistConstraintDoubleData), fieldName).ToInt32();
}

public class ConeTwistConstraint : TypedConstraint
{
    public ConeTwistConstraint(RigidBody rigidBodyA, RigidBody rigidBodyB, Matrix4x4 rigidBodyAFrame, Matrix4x4 rigidBodyBFrame)
    {
        IntPtr native = btConeTwistConstraint_new(rigidBodyA.Native, rigidBodyB.Native, ref rigidBodyAFrame, ref rigidBodyBFrame);
