...
public class MultiBodyPoint2Point : MultiBodyConstraint
{
    ...
    {
        IntPtr native = btMultiBodyPoint2Point_new(body.Native, link, bodyB != null ? bodyB.Native : IntPtr.Zero, ref pivotInA, ref pivotInB);
    ...
    {
        IntPtr native = btMultiBodyPoint2Point_new2(bodyA.Native, linkA, bodyB.Native, linkB, ref pivotInA, ref pivotInB);
        InitializeUserOwned(native);
