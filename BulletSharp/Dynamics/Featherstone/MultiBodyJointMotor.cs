...
public class MultiBodyJointMotor : MultiBodyConstraint
{
    ...
    {
        IntPtr native = btMultiBodyJointMotor_new(body.Native, link, desiredVelocity, maxMotorImpulse);
    ...
    {
        IntPtr native = btMultiBodyJointMotor_new2(body.Native, link, linkDoF, desiredVelocity, maxMotorImpulse);
        InitializeUserOwned(native);
        InitializeMembers(body, body);
    }
