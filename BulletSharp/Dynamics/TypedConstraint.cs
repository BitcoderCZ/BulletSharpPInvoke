...
internal struct TypedConstraintFloatData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(TypedConstraintFloatData), fieldName).ToInt32();
}
...
internal struct TypedConstraintDoubleData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(TypedConstraintDoubleData), fieldName).ToInt32();
}
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    public int CalculateSerializeBufferSize()
        => btTypedConstraint_calculateSerializeBufferSize(Native);
    ...
    public float GetParam(ConstraintParam num)
        => btTypedConstraint_getParam(Native, num);

    public float GetParam(ConstraintParam num, int axis)
        => btTypedConstraint_getParam2(Native, num, axis);

    public float InternalGetAppliedImpulse()
        => btTypedConstraint_internalGetAppliedImpulse(Native);
    ...
    public string Serialize(IntPtr dataBuffer, Serializer serializer)
        => Marshal.PtrToStringAnsi(btTypedConstraint_serialize(Native, dataBuffer, serializer.Native));
    ...
    [MemberNotNull(nameof(RigidBodyA), nameof(RigidBodyB))]
...
public class AngularLimit : BulletDisposableObject
{
    ...
    public void Set(float low, float high, float softness = 0.9f, float biasFactor = 0.3f, float relaxationFactor = 1.0f)
