...
public class JointFeedback : BulletDisposableObject
{
    ...
    protected override void Dispose(bool disposing) => btJointFeedback_delete(Native);
}
...
public abstract class TypedConstraint : BulletDisposableObject
{
    public class ConstraintInfo1 : BulletDisposableObject
    {
        ...
        protected override void Dispose(bool disposing) => btTypedConstraint_btConstraintInfo1_delete(Native);
    }
    ...
    public class ConstraintInfo2 : BulletDisposableObject
    {
        ...
        /*
			...
			*/
        protected override void Dispose(bool disposing) => btTypedConstraint_btConstraintInfo2_delete(Native);
    }
    ...
    public void BuildJacobian() => btTypedConstraint_buildJacobian(Native);

    public int CalculateSerializeBufferSize() => btTypedConstraint_calculateSerializeBufferSize(Native);

    public void EnableFeedback(bool needsFeedback) => btTypedConstraint_enableFeedback(Native, needsFeedback);
    ...
    public void GetInfo1(ConstraintInfo1 info) => btTypedConstraint_getInfo1(Native, info.Native);

    public void GetInfo2(ConstraintInfo2 info) => btTypedConstraint_getInfo2(Native, info.Native);

    public float GetParam(ConstraintParam num) => btTypedConstraint_getParam(Native, num);

    public float GetParam(ConstraintParam num, int axis) => btTypedConstraint_getParam2(Native, num, axis);

    public float InternalGetAppliedImpulse() => btTypedConstraint_internalGetAppliedImpulse(Native);

    public void InternalSetAppliedImpulse(float appliedImpulse) => btTypedConstraint_internalSetAppliedImpulse(Native, appliedImpulse);

    public string Serialize(IntPtr dataBuffer, Serializer serializer) => Marshal.PtrToStringAnsi(btTypedConstraint_serialize(Native, dataBuffer, serializer.Native));

    public void SetParam(ConstraintParam num, float value) => btTypedConstraint_setParam(Native, num, value);

    public void SetParam(ConstraintParam num, float value, int axis) => btTypedConstraint_setParam2(Native, num, value, axis);
    /*
    ...
    protected override void Dispose(bool disposing) => btTypedConstraint_delete(Native);
}
...
public class AngularLimit : BulletDisposableObject
{
    ...
    public void Fit(ref float angle) => btAngularLimit_fit(Native, ref angle);

    public void Set(float low, float high, float softness = 0.9f, float biasFactor = 0.3f,
        float relaxationFactor = 1.0f) => btAngularLimit_set(Native, low, high, softness, biasFactor, relaxationFactor);

    public void Test(float angle) => btAngularLimit_test(Native, angle);
...
internal struct TypedConstraintFloatData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(TypedConstraintFloatData), fieldName).ToInt32();
}
...
internal struct TypedConstraintDoubleData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(TypedConstraintDoubleData), fieldName).ToInt32();
}
