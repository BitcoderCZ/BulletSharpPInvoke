...
internal struct HingeConstraintFloatData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(HingeConstraintFloatData), fieldName).ToInt32();
}
...
internal struct HingeConstraintDoubleData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(HingeConstraintDoubleData), fieldName).ToInt32();
}
...
public class HingeConstraint : TypedConstraint
{
    ...
    {
        IntPtr native = btHingeConstraint_new(rigidBodyA.Native, rigidBodyB.Native, ref pivotInA, ref pivotInB, ref axisInA, ref axisInB, useReferenceFrameA);
    ...
    {
        IntPtr native = btHingeConstraint_new2(rigidBodyA.Native, ref pivotInA, ref axisInA, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, GetFixedBody());
    }

    public HingeConstraint(RigidBody rigidBodyA, RigidBody rigidBodyB, Matrix4x4 rigidBodyAFrame, Matrix4x4 rigidBodyBFrame, bool useReferenceFrameA = false)
    {
        IntPtr native = btHingeConstraint_new3(rigidBodyA.Native, rigidBodyB.Native, ref rigidBodyAFrame, ref rigidBodyBFrame, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, rigidBodyB);
    }
    ...
    {
        IntPtr native = btHingeConstraint_new4(rigidBodyA.Native, ref rigidBodyAFrame, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, GetFixedBody());
    }
    ...
    public void EnableAngularMotor(bool enableMotor, float targetVelocity, float maxMotorImpulse)
        => btHingeConstraint_enableAngularMotor(Native, enableMotor, targetVelocity, maxMotorImpulse);

    public float GetHingeAngleRef(ref Matrix4x4 transA, ref Matrix4x4 transB)
        => btHingeConstraint_getHingeAngle(Native, ref transA, ref transB);
    ...
    public void GetInfo2Internal(ConstraintInfo2 info, Matrix4x4 transA, Matrix4x4 transB, Vector3 angVelA, Vector3 angVelB)
        => btHingeConstraint_getInfo2Internal(Native, info.Native, ref transA, ref transB, ref angVelA, ref angVelB);

    public void GetInfo2InternalUsingFrameOffset(ConstraintInfo2 info, Matrix4x4 transA, Matrix4x4 transB, Vector3 angVelA, Vector3 angVelB)
        => btHingeConstraint_getInfo2InternalUsingFrameOffset(Native, info.Native, ref transA, ref transB, ref angVelA, ref angVelB);

    public void GetInfo2NonVirtual(ConstraintInfo2 info, Matrix4x4 transA, Matrix4x4 transB, Vector3 angVelA, Vector3 angVelB)
        => btHingeConstraint_getInfo2NonVirtual(Native, info.Native, ref transA, ref transB, ref angVelA, ref angVelB);
    ...
    public void SetLimit(float low, float high, float softness, float biasFactor, float relaxationFactor)
        => btHingeConstraint_setLimit4(Native, low, high, softness, biasFactor, relaxationFactor);
...
{
    public HingeAccumulatedAngleConstraint(RigidBody rigidBodyA, RigidBody rigidBodyB, Vector3 pivotInA, Vector3 pivotInB, Vector3 axisInA, Vector3 axisInB, bool useReferenceFrameA = false)
    {
        IntPtr native = btHingeAccumulatedAngleConstraint_new(rigidBodyA.Native, rigidBodyB.Native, ref pivotInA, ref pivotInB, ref axisInA, ref axisInB, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, rigidBodyB);
    }

    public HingeAccumulatedAngleConstraint(RigidBody rigidBodyA, Vector3 pivotInA, Vector3 axisInA, bool useReferenceFrameA = false)
    {
        IntPtr native = btHingeAccumulatedAngleConstraint_new2(rigidBodyA.Native, ref pivotInA, ref axisInA, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, GetFixedBody());
    }

    public HingeAccumulatedAngleConstraint(RigidBody rigidBodyA, RigidBody rigidBodyB, Matrix4x4 rigidBodyAFrame, Matrix4x4 rigidBodyBFrame, bool useReferenceFrameA = false)
    {
        IntPtr native = btHingeAccumulatedAngleConstraint_new3(rigidBodyA.Native, rigidBodyB.Native, ref rigidBodyAFrame, ref rigidBodyBFrame, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, GetFixedBody());
    }

    public HingeAccumulatedAngleConstraint(RigidBody rigidBodyA, Matrix4x4 rigidBodyAFrame, bool useReferenceFrameA = false)
    {
        IntPtr native = btHingeAccumulatedAngleConstraint_new4(rigidBodyA.Native, ref rigidBodyAFrame, useReferenceFrameA);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, GetFixedBody());
    }
