...
public class RotationalLimitMotor2 : BulletDisposableObject
{
    ...
    public void TestLimitValue(float testValue) => btRotationalLimitMotor2_testLimitValue(Native, testValue);
...
public class TranslationalLimitMotor2 : BulletDisposableObject
{
    ...
    public bool IsLimited(int limitIndex) => btTranslationalLimitMotor2_isLimited(Native, limitIndex);

    public void TestLimitValue(int limitIndex, float testValue) => btTranslationalLimitMotor2_testLimitValue(Native, limitIndex, testValue);
...
public class Generic6DofSpring2Constraint : TypedConstraint
{
    ...
    public static float BtGetMatrixElem(Matrix4x4 mat, int index) => btGeneric6DofSpring2Constraint_btGetMatrixElem(ref mat, index);

    public void CalculateTransforms(Matrix4x4 transA, Matrix4x4 transB) => btGeneric6DofSpring2Constraint_calculateTransforms(Native, ref transA,
            ref transB);

    public void CalculateTransforms() => btGeneric6DofSpring2Constraint_calculateTransforms2(Native);

    public void EnableMotor(int index, bool onOff) => btGeneric6DofSpring2Constraint_enableMotor(Native, index, onOff);

    public void EnableSpring(int index, bool onOff) => btGeneric6DofSpring2Constraint_enableSpring(Native, index, onOff);

    public float GetAngle(int axisIndex) => btGeneric6DofSpring2Constraint_getAngle(Native, axisIndex);
    ...
    public float GetRelativePivotPosition(int axisIndex) => btGeneric6DofSpring2Constraint_getRelativePivotPosition(Native,
            axisIndex);
    ...
    public bool IsLimited(int limitIndex) => btGeneric6DofSpring2Constraint_isLimited(Native, limitIndex);

    public static bool MatrixToEulerZXY(Matrix4x4 mat, ref Vector3 xyz) => btGeneric6DofSpring2Constraint_matrixToEulerZXY(ref mat, ref xyz);

    public static bool MatrixToEulerZYX(Matrix4x4 mat, ref Vector3 xyz) => btGeneric6DofSpring2Constraint_matrixToEulerZYX(ref mat, ref xyz);

    public static bool MatrixToEulerXZY(Matrix4x4 mat, ref Vector3 xyz) => btGeneric6DofSpring2Constraint_matrixToEulerXZY(ref mat, ref xyz);

    public static bool MatrixToEulerXYZ(Matrix4x4 mat, ref Vector3 xyz) => btGeneric6DofSpring2Constraint_matrixToEulerXYZ(ref mat, ref xyz);

    public static bool MatrixToEulerYZX(Matrix4x4 mat, ref Vector3 xyz) => btGeneric6DofSpring2Constraint_matrixToEulerYZX(ref mat, ref xyz);

    public static bool MatrixToEulerYXZ(Matrix4x4 mat, ref Vector3 xyz) => btGeneric6DofSpring2Constraint_matrixToEulerYXZ(ref mat, ref xyz);

    public void SetAxis(Vector3 axis1, Vector3 axis2) => btGeneric6DofSpring2Constraint_setAxis(Native, ref axis1, ref axis2);

    public void SetBounce(int index, float bounce) => btGeneric6DofSpring2Constraint_setBounce(Native, index, bounce);

    public void SetDamping(int index, float damping, bool limitIfNeeded = true) => btGeneric6DofSpring2Constraint_setDamping(Native, index, damping, limitIfNeeded);

    public void SetEquilibriumPoint() => btGeneric6DofSpring2Constraint_setEquilibriumPoint(Native);

    public void SetEquilibriumPoint(int index, float val) => btGeneric6DofSpring2Constraint_setEquilibriumPoint2(Native, index, val);

    public void SetEquilibriumPoint(int index) => btGeneric6DofSpring2Constraint_setEquilibriumPoint3(Native, index);

    public void SetFrames(Matrix4x4 frameA, Matrix4x4 frameB) => btGeneric6DofSpring2Constraint_setFrames(Native, ref frameA, ref frameB);

    public void SetLimit(int axis, float lo, float hi) => btGeneric6DofSpring2Constraint_setLimit(Native, axis, lo, hi);

    public void SetLimitReversed(int axis, float lo, float hi) => btGeneric6DofSpring2Constraint_setLimitReversed(Native, axis, lo, hi);

    public void SetMaxMotorForce(int index, float force) => btGeneric6DofSpring2Constraint_setMaxMotorForce(Native, index, force);

    public void SetServo(int index, bool onOff) => btGeneric6DofSpring2Constraint_setServo(Native, index, onOff);

    public void SetServoTarget(int index, float target) => btGeneric6DofSpring2Constraint_setServoTarget(Native, index, target);

    public void SetStiffness(int index, float stiffness, bool limitIfNeeded = true) => btGeneric6DofSpring2Constraint_setStiffness(Native, index, stiffness,
            limitIfNeeded);

    public void SetTargetVelocity(int index, float velocity) => btGeneric6DofSpring2Constraint_setTargetVelocity(Native, index, velocity);
...
internal unsafe struct Generic6DofSpring2ConstraintFloatData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(Generic6DofSpring2ConstraintFloatData), fieldName).ToInt32();
}
...
internal unsafe struct Generic6DofSpring2ConstraintDoubleData
{
    ...
    public static int Offset(string fieldName) => Marshal.OffsetOf(typeof(Generic6DofSpring2ConstraintDoubleData), fieldName).ToInt32();
}
