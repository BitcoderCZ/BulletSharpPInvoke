...
internal unsafe struct Generic6DofSpring2ConstraintFloatData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(Generic6DofSpring2ConstraintFloatData), fieldName).ToInt32();
}
...
internal unsafe struct Generic6DofSpring2ConstraintDoubleData
{
    ...
    public static int Offset(string fieldName)
        => Marshal.OffsetOf(typeof(Generic6DofSpring2ConstraintDoubleData), fieldName).ToInt32();
}
...
public class TranslationalLimitMotor2 : BulletDisposableObject
{
    ...
    public bool IsLimited(int limitIndex)
        => btTranslationalLimitMotor2_isLimited(Native, limitIndex);
...
{
    private readonly RotationalLimitMotor2[] _angularLimits = new RotationalLimitMotor2[3];
    private TranslationalLimitMotor2? _linearLimits;

    public Generic6DofSpring2Constraint(RigidBody rigidBodyA, RigidBody rigidBodyB, Matrix4x4 frameInA, Matrix4x4 frameInB, RotateOrder rotOrder = RotateOrder.XYZ)
    {
        IntPtr native = btGeneric6DofSpring2Constraint_new(rigidBodyA.Native, rigidBodyB.Native, ref frameInA, ref frameInB, rotOrder);
        InitializeUserOwned(native);
        InitializeMembers(rigidBodyA, rigidBodyB);
    }

    public Generic6DofSpring2Constraint(RigidBody rigidBodyB, Matrix4x4 frameInB, RotateOrder rotOrder = RotateOrder.XYZ)
    {
        IntPtr native = btGeneric6DofSpring2Constraint_new2(rigidBodyB.Native, ref frameInB, rotOrder);
        InitializeUserOwned(native);
    ...
    public static float BtGetMatrixElem(Matrix4x4 mat, int index)
        => btGeneric6DofSpring2Constraint_btGetMatrixElem(ref mat, index);

    public static bool MatrixToEulerZXY(Matrix4x4 mat, ref Vector3 xyz)
        => btGeneric6DofSpring2Constraint_matrixToEulerZXY(ref mat, ref xyz);

    public static bool MatrixToEulerZYX(Matrix4x4 mat, ref Vector3 xyz)
        => btGeneric6DofSpring2Constraint_matrixToEulerZYX(ref mat, ref xyz);

    public static bool MatrixToEulerXZY(Matrix4x4 mat, ref Vector3 xyz)
        => btGeneric6DofSpring2Constraint_matrixToEulerXZY(ref mat, ref xyz);

    public static bool MatrixToEulerXYZ(Matrix4x4 mat, ref Vector3 xyz)
        => btGeneric6DofSpring2Constraint_matrixToEulerXYZ(ref mat, ref xyz);

    public static bool MatrixToEulerYZX(Matrix4x4 mat, ref Vector3 xyz)
        => btGeneric6DofSpring2Constraint_matrixToEulerYZX(ref mat, ref xyz);

    public static bool MatrixToEulerYXZ(Matrix4x4 mat, ref Vector3 xyz)
        => btGeneric6DofSpring2Constraint_matrixToEulerYXZ(ref mat, ref xyz);

    public void CalculateTransforms(Matrix4x4 transA, Matrix4x4 transB)
        => btGeneric6DofSpring2Constraint_calculateTransforms(Native, ref transA, ref transB);
    ...
    public float GetAngle(int axisIndex)
        => btGeneric6DofSpring2Constraint_getAngle(Native, axisIndex);
    ...
    public float GetRelativePivotPosition(int axisIndex)
        => btGeneric6DofSpring2Constraint_getRelativePivotPosition(Native, axisIndex);
    ...
    public bool IsLimited(int limitIndex)
        => btGeneric6DofSpring2Constraint_isLimited(Native, limitIndex);
    ...
    public void SetStiffness(int index, float stiffness, bool limitIfNeeded = true)
        => btGeneric6DofSpring2Constraint_setStiffness(Native, index, stiffness, limitIfNeeded);
